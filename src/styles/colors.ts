...
export const colors = {
  // 메인 색상 - 보라색 계열
  primary: {
    light: '#4975D4',    // (네비게이션 배경)
    DEFAULT: '#BCD5F7',  // 기본 보라색
    dark: '#DCE5F9',     // 진한 보라색 (클릭/활성화)
...
export const tailwindColors = {
  // 네비게이션 바
  nav: {
    bg: 'bg-[#4975D4]',           // 연한 보라색 배경
    hover: 'hover:bg-[#8cace5]',  // 호버 시
    active: 'bg-[#DCE5F9]',       // 활성화 시 진한 보라색
    text: 'text-[#BCD5F7]',       // 텍스트
    activeText: 'text-[#4975D4]',      // 활성화 텍스트
  },
  ...
  // 버튼
  button: {
    primary: 'bg-[#BCD5F7], hover:bg-[#DCE5F9] text-white',
    secondary: 'bg-[#4975D4] hover:bg-[#DCE5F9] text-black',
